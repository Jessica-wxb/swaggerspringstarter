...
import com.yunlifly.starter.swaggerspringstarter.infra.condition.SwaggerCondition;
import com.yunlifly.starter.swaggerspringstarter.infra.config.SwaggerProperties;
...
// 当配置文件中 swagger 的值为true时，实例化此类。可以不填
...
// 构建api文档的下你关系信息函数，注意这里的注解引用的是哪个
